...
exports['default'] = function () {
  ...
  var calendarHeight = defaultTheme.Calendar._height;
  ...
  var cellSizeWidth = (parseInt(calendarWidth) - parseInt(calendarPadding) * 2) / 7 - parseInt(cellMargin) * 2;
  var cellSizeHeight = (parseInt(calendarHeight) - parseInt(calendarPadding) * 2) / 7 - parseInt(cellMargin) * 2;
